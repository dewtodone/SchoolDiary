...
import { View, TouchableOpacity, Button, Text, StyleSheet, Dimensions, LayoutAnimation, Platform, UIManager } from "react-native";
...
export default class test extends Component {
    ...
    render() {
        return (
            <View><Text>asdasdada</Text></View>
            // <View  style={{width:'90%', left:'5%', height:200 }}>
    ...
    //             source={{uri: 'http://api.ngs.edu.pk/Content/Files/eLearning/Assignments/video_20200505_163504[1]_20200507112248058.mp4'}}
    //             style={styles.fullScreen}
...
//                <Video source={{uri: "http://api.ngs.edu.pk/Content/Files/eLearning/Assignments/video_20200505_163504[1]_20200507112248058.mp4"}}   // Can be a URL or a local file.
//        ref={(ref) => {
//          this.player = ref
//        }}    
//        fullscreen = {true}     
